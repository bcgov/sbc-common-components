...
import { LDFlags, Pages, SessionStorageKeys } from '../src/util/constants'
...
export default class App extends Vue {
  ...
  private readonly toastType: string = 'primary'
  private readonly toastTimeout: number = 6000
  private readonly logoutUrl: string = ''
  private readonly aboutText: string = 'SBC Common Components being upgraded to Vue 3'

  // Lifecycle hooks
  mounted(): void {
    sessionStorage.setItem(
      SessionStorageKeys.StatusApiUrl,
  ...
  // Methods
  private setCurrentOrganization(value: any): void {}
