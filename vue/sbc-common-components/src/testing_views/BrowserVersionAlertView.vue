<template>
  <div>
    ...
    <h2>
      Please refer to the note at the top of BrowerVersionAlertView.vue if
      you are using this page to test the BrowserVersionAlert component.
    </h2>
    <br><br>
    <v-card>
      <v-card-title>
